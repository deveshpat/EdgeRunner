...
def write_kernel_bundle(
    ...
    # Official SaveKernel machine_shape only: NvidiaTeslaT4 | NvidiaTeslaP100
    # (Dual T4 is not in the public enum.) Never omit shape with enable_gpu —
    # that defaults to P100.
    machine_shape_map = {
        "t4x2": "NvidiaTeslaT4",
        "gpu": "NvidiaTeslaT4",
        "t4": "NvidiaTeslaT4",
